...
function Beam.schema:Constrain(dt: number)
	...
	local lambda = (-((P2.Position-P1.Position).Magnitude-self.DesiredLength)-gamma*(self.Position-self.LastPosition))
		/((1 + gamma)*(1/self.P1.Mass+1/self.P2.Mass) + 1/(self.Stiffness*dt))
